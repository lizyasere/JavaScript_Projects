...
//Using Prompt to allow a user input value year
...
//Using Readline so that the user can input year from terminal because with prompt, you can ony do that from browser
